      ...
      >
        {({
          ...
          <div className="w-[80%] flex flex-col items-center">
            <div className="glass-morphism addMenuElement rounded-full p-4  w-full flex justify-around mb-2">
              <svg
                ...
                viewBox="0 0 29 30"
                fill="none"
                className="pl-[1%] text-text cursor-pointer hover:scale-105 transition-transform duration-300"
              >
            ...
            <ul
              {...getMenuProps()}
              className="w-full p-[3%] mt-[2%] max-h-[20vh] overflow-y-auto flex flex-col gap-[1vh] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
            >
      ...
      <div className="w-full flex-grow overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 p-5">
        {workspaceSections.map((section, index) => (
          <div key={section.id || index} className="mb-3">
            <div className="addMenuElement rounded-full flex justify-between items-center bg-primary gradient-border p-3">
              ...
              {allowedToDelete && (
                <svg
                  ...
                  height="20"
                  viewBox="0 0 24 24"
                  className="cursor-pointer text-text hover:text-dominant transition-all"
                  onClick={() =>
