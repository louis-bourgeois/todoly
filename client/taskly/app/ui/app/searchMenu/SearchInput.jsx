  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className="w-full h-[7vh] min-h-[40px] px-[2vw] py-[1vw] text-[1.2vw] text-gray-700 bg-primary border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-dominant-500 focus:border-transparent transition-all duration-300 ease-in-out shadow-sm hover:shadow-md"
      />
      <svg
