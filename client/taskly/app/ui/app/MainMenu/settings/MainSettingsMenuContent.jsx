...
const icons = [
  <SVGIcon key="icon1" className="w-[2.5vw] h-[4.44vh]">
    <path
  ...
  <SVGIcon key="icon2" className="w-[2.5vw] h-[4.44vh]">
    <path
  ...
  <SVGIcon key="icon3" className="w-[2.5vw] h-[4.44vh]">
    <path
  ...
  <SVGIcon key="icon4" className="w-[2.5vw] h-[4.44vh]">
    <path
  ...
  <SVGIcon key="icon5" className="w-[2.5vw] h-[4.44vh]">
    <path
  ...
  <SVGIcon key="icon6" className="w-[2.5vw] h-[4.44vh]">
    <path
