...
const ProfilePhoto = ({ currentPhotoUrl, defaultSrc }) => {
  ...
  return (
    <div
      className="relative w-[150px] h-[150px] rounded-full overflow-hidden cursor-pointer group flex items-center justify-center"
