              ...
              >
                <SlideNav key={index}>
                  <div className="flex justify-between ">
                    {" "}
                    <h2 className="text-5xl font-extrabold px-5">
                      {workspace.name}
                    </h2>
                    <button
                      onClick={() => {
        ...
        <Slide index={workspaces.length} key="add-workspace">
          <div className="flex items-center justify-center h-full">
            <button
              ...
              className="px-6 py-3 bg-blue text-white rounded-full hover:bg-opacity-80 transition-colors duration-200 text-lg font-semibold"
            >
              Add Workspace
            </button>
          </div>
